...
\- 6,600 total records  
\- Fields: name, ts, open\_stock, close\_stock, difference  
\#\# Dataset Statistics  
...
\- \*\*SNDK\*\* is the top performer with the highest average % change,   
  driven by strong gains in January and May 2026\.  
\- \*\*STX and WDC\*\* are also among the top performers, suggesting   
  the storage sector performed well overall during this period.  
\- \*\*PODD\*\* is the worst performer with the most negative average   
  % change, showing consistent weakness throughout the period.  
